  ...
  return (
    <footer className='footer'>
      ...
      <div className='container footer__layout'>
        <div className='footer__brand'>
          ...
          <p className='footer__blurb'>
            Mar Athanasius College of Engineering Student Branch of IEEE.
            Promoting excellence and engineering innovation for the benefit of
            humanity since 1988.
          </p>
        </div>
      ...
      <div className='container footer__base'>
        <p>
          © <span id='footer-year'>{new Date().getFullYear()}</span> IEEE MACE.
          All rights reserved.
        </p>
