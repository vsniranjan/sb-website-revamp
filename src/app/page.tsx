...
export default function HomePage() {
  return (
    <SectionAnimations>
      <HeroIntro>
        ...
        <div className='container hero__layout'>
          ...
          <h1 className='hero__title'>
            ...
            <span className='outline'>Shaping&nbsp;Tomorrow.</span>
          </h1>
        ...
        <div className='container'>
          <header className='section__head'>
            ...
            <p className='section__subtext'>
              Understand the foundation of the world&apos;s largest technical
      ...
      <section
        className='whyjoin section'
        id='whyjoin'
        aria-labelledby='whyjoin-heading'
      >
        <div className='container'>
          <header className='section__head'>
            ...
            <h2 className='section__title' id='whyjoin-heading'>
              Unlock a World of{" "}
              <span className='outline'>Technical Opportunity</span>
            </h2>
            <p className='section__subtext'>
              Joining IEEE is not just about a membership card — it is an
              investment in your career, your network, and your future. Student
              members gain immediate access to global resources, funding, and
              leadership roles.
            </p>
          </header>
          <div className='whyjoin__layout'>
            <aside className='whyjoin__stat'>
              ...
              <p className='whyjoin__stat-label'>
                Members in Over 160 Countries
              </p>
              <p className='whyjoin__stat-note'>
                Join the largest technical professional network in the world.
              </p>
            </aside>
            <BenefitsList />
          </div>
      ...
      <section
        className='fact-wheel-section section'
        id='fun'
      ...
      >
        <div className='container'>
          <header className='section__head'>
            ...
            <h2 className='section__title' id='fun-heading'>
              A Little <span className='outline'>Detour</span>
            </h2>
            {/* <p className='section__subtext'>
              No grades, no deadlines — spin for a fact, add a spark, jump a few
              obstacles.
            </p> */}
          </header>
          <div className='playground__layout'>
            ...
            <div className='playground__block' data-reveal>
              <p className='eyebrow'>Reaction test</p>
              <ReflexTest />
            </div>
            <div className='playground__block' data-reveal>
